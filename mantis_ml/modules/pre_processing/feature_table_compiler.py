...
class FeatureTableCompiler:
	...
	def compile_feature_tables_per_class(self, wv):
...
#			 self.full_features_df = filtered_by_tissue_df.copy()
	...
	def impute_missing_data(self):
		...
		self.full_features_df = self.full_features_df.fillna(self.full_features_df.median())
	...
	def run(self, wv):
		...
		self.compile_feature_tables_per_class(wv)
