# - Author: 'leo@opensignal.com'
# A pure-python implementation of the UpSet suite of visualisation methods by Lex, Gehlenborg et al., forked from ImSoErgodic/py-upset https://github.com/ImSoErgodic/py-upset
# Cloned from https://github.com/pedromiravaz/py-upset

# --- Edited: line 609
# order = np.argsort(-inters_degrees) 
# to have intersections plotted in decreasing order of degree
# ---
